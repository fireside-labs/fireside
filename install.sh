...
echo -e "${DIM}       │${NC}   ${AMBER}${BOLD}◆  W E L C O M E   T O   F I R E S I D E  ◆${NC}   ${DIM}│${NC}"
echo -e "${DIM}       │${NC}                                                  ${DIM}│${NC}"
echo -e "${DIM}       │${NC}              ${AMBER}🔥${NC}  ${DIM}v${VERSION}${NC}  ${AMBER}🔥${NC}                  ${DIM}│${NC}"
echo -e "${DIM}       │${NC}                                                  ${DIM}│${NC}"
echo -e "${DIM}       │${NC}     ${DIM}The AI companion that learns while${NC}          ${DIM}│${NC}"
echo -e "${DIM}       │${NC}     ${DIM}you sleep. This takes about 2 min.${NC}          ${DIM}│${NC}"
echo -e "${DIM}       │${NC}                                                  ${DIM}│${NC}"
echo -e "${DIM}       └──────────────────────────────────────────────────┘${NC}"
echo ""
sleep 1
...
echo -e "${DIM}       ┌──────────────────────────────────────────────────┐${NC}"
echo -e "${DIM}       │${NC}                                                  ${DIM}│${NC}"
echo -e "${DIM}       │${NC}   ${AMBER}${BOLD}◆  Ready to install${NC}                            ${DIM}│${NC}"
echo -e "${DIM}       │${NC}                                                  ${DIM}│${NC}"
echo -e "${DIM}       │${NC}      ${DIM}Owner${NC}       ${BOLD}${USER_NAME}$(printf '%*s' $((26 - ${#USER_NAME})) '')${NC}${DIM}│${NC}"
echo -e "${DIM}       │${NC}      ${DIM}Brain${NC}       ${BOLD}${BRAIN_LABEL}$(printf '%*s' $((26 - ${#BRAIN_LABEL})) '')${NC}${DIM}│${NC}"
echo -e "${DIM}       │${NC}      ${DIM}Companion${NC}   ${BOLD}${PET_EMOJI} ${PET_NAME}$(printf '%*s' $((24 - ${#PET_NAME})) '')${NC}${DIM}│${NC}"
echo -e "${DIM}       │${NC}      ${DIM}Location${NC}    ${BOLD}~/.fireside$(printf '%*s' 16 '')${NC}${DIM}│${NC}"
echo -e "${DIM}       │${NC}                                                  ${DIM}│${NC}"
echo -e "${DIM}       └──────────────────────────────────────────────────┘${NC}"
echo ""
...
echo -e "${DIM}       ┌──────────────────────────────────────────────────┐${NC}"
echo -e "${DIM}       │${NC}                                                  ${DIM}│${NC}"
echo -e "${DIM}       │${NC}        ${AMBER}${BOLD}◆  F I R E S I D E   I S   L I V E  ◆${NC}     ${DIM}│${NC}"
echo -e "${DIM}       │${NC}                                                  ${DIM}│${NC}"
echo -e "${DIM}       │${NC}               ${AMBER}🔥🔥🔥${NC}                            ${DIM}│${NC}"
echo -e "${DIM}       │${NC}                                                  ${DIM}│${NC}"
echo -e "${DIM}       └──────────────────────────────────────────────────┘${NC}"
echo ""
...
echo -e "${DIM}       ┌──────────────────────────────────────────────────┐${NC}"
echo -e "${DIM}       │${NC}                                                  ${DIM}│${NC}"
echo -e "${DIM}       │${NC}   ${BOLD}Things to try:${NC}                                 ${DIM}│${NC}"
echo -e "${DIM}       │${NC}                                                  ${DIM}│${NC}"
echo -e "${DIM}       │${NC}     ${AMBER}1.${NC}  Say ${ITALIC}\"Hello ${PET_NAME}!\"${NC}$(printf '%*s' $((29 - ${#PET_NAME})) '')${DIM}│${NC}"
echo -e "${DIM}       │${NC}     ${AMBER}2.${NC}  Ask ${ITALIC}\"Take me for a walk\"${NC}                   ${DIM}│${NC}"
echo -e "${DIM}       │${NC}     ${AMBER}3.${NC}  Say ${ITALIC}\"Remember: I like coffee black\"${NC}        ${DIM}│${NC}"
echo -e "${DIM}       │${NC}     ${AMBER}4.${NC}  Ask ${ITALIC}\"Translate 'hello' to Japanese\"${NC}       ${DIM}│${NC}"
echo -e "${DIM}       │${NC}                                                  ${DIM}│${NC}"
echo -e "${DIM}       └──────────────────────────────────────────────────┘${NC}"
echo ""
echo ""
