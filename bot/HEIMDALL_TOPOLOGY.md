...
- **`bifrost_local.heimdall.py`** (named, in Odin's repo) IS tracked — reference/backup
- Security modules (`circuit_breaker.py`, `prompt_guard.py` etc.) ARE tracked — separate files
