...
MODELS = [
    ...
    # ==========================================
    # CLOUD — BRING YOUR OWN KEY (OpenAI, Anthropic, Google)
    # ==========================================
    {
        "id": "cloud-gpt-4o",
        "name": "GPT-4o",
        ...
        "tier": "paid",
        "category": "general",
        "description": "OpenAI's flagship. 128K context, vision, function calling. $2.50/1M input, $10/1M output.",
    ...
    },
    {
        ...
        "tier": "paid",
        "category": "general",
        "description": "Fast and cheap. 128K context. Great for simple tasks. $0.15/1M input, $0.60/1M output.",
    ...
    },
    {
        ...
        "tier": "paid",
        "category": "reasoning",
        "description": "OpenAI's reasoning model. 200K context, chain-of-thought. $15/1M input, $60/1M output.",
    ...
    },
    {
        ...
        "tier": "paid",
        "category": "general",
        "description": "Anthropic's latest. 200K context, excellent coding + reasoning. $3/1M input, $15/1M output.",
    ...
    },
    {
        ...
        "tier": "paid",
        "category": "general",
        "description": "Fastest Claude. 200K context, great for chat. $0.80/1M input, $4/1M output.",
    ...
    },
    {
        ...
        "tier": "paid",
        "category": "reasoning",
        "description": "Google's best. 1M context window, multimodal. $1.25/1M input, $10/1M output.",
    ...
    },
    {
        ...
        "tier": "paid",
        "category": "general",
        "description": "Fastest Gemini. 1M context, very cheap. $0.15/1M input, $0.60/1M output.",
        "pricing": {"input_per_1m": 0.15, "output_per_1m": 0.60},
    },
