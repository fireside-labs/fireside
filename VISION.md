...
| **11** | **On-Device Brain** | Small LLM on phone, offline chat/browse/guardian/translate |
| **12** | **Native Integration** | iOS Calendar, Contacts, Messages via Siri Shortcuts |
| **13** | **Hosted Mode** | RunPod containers, Supabase auth, subscription billing |
