...
async def post_chat(req: ChatRequest):
    ...
    # ── Tool schemas + executor from shared module ──
    from tool_defs import TOOL_SCHEMAS, execute_tool as _sync_execute_tool

    async def _execute_tool(name: str, arguments: dict) -> str:
        """Async wrapper around the shared sync tool executor."""
        return _sync_execute_tool(name, arguments)
